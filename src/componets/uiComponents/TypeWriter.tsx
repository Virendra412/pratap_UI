...
interface propsInterface{
    ...
    duration: number,
    cusorClass: string | null,
    onClick:React.MouseEventHandler<HTMLSpanElement>
    
}


const TypeWriter = ({children,className,duration=2,cusorClass, ...props}:propsInterface) => {
    ...
    return (
      <div className='h-fit relative inline-block '>
            ...
            <motion.div className={twMerge(' w-[2px] mt h-[95%] inline-block text-transparent -right-1 bg-white absolute',cusorClass)} animate={{ opacity: [0, 0, 1, 1], transition: { duration: 1, repeat: Infinity, repeatDelay: 0, ease: "linear", times: [0, 0.5, 0.5, 1] } }}></motion.div>
