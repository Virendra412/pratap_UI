...
const TypeWriter = ({children=['examle text'],className,duration=2,cursorClass, ...props}:propsInterface) => {
    ...
    return (
      <div className='h-fit relative inline-block '>
            ...
            <motion.div className={twMerge(' w-[2px] mt h-[95%] inline-block text-transparent -right-1 bg-black absolute',cursorClass)} animate={{ opacity: [0, 0, 1, 1], transition: { duration: 1, repeat: Infinity, repeatDelay: 0, ease: "linear", times: [0, 0.5, 0.5, 1] } }}></motion.div>
