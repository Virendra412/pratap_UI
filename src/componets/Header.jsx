    ...
    >
      <div>
        ...
        <div className="buttons flex justify-center gap-5 md:gap-10 mt-6 items-center">
          <Link
            className=" py-2 px-2 sm:px-5 text-xs sm:text-sm bg-zinc-100 dark:bg-zinc-700 rounded-md  md:py-2 flex items-center "
            to="/components"
          >
            Browse Components
            <svg
              ...
              className="lucide lucide-chevron-right ml-1.5 h-4 w-4"
            >
          ...
          <Link to={'https://github.com/udaypratap1112'} className=" py-2 bg-black text-xs sm:text-sm px-2 sm:px-5 text-white dark:bg-white dark:text-black  rounded-md  md:py-2 flex items-center ">
            <svg
              ...
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
              className="mr-1.5 h-4 w-4 sm:h-5 sm:w-5 fill-white dark:fill-zinc-950"
            >
              <title>GitHub</title>
